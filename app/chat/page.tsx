    ...
    <Container>
      ...
      <div className="w-[65rem] h-[40rem] bg-none rounded-tr-3xl rounded-br-3xl flex shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px]">
        <div className="w-96  border-gray-200 bg-white rounded-tr-3xl rounded-br-3xl">
          <div className="shadow-[0px_3px_5px_0px_#A0AEC0] flex items-center h-28 justify-center ">
            {isClicked ? "SETTINGS" : "Members"}
          </div>
        </div>
        <div className=" w-[42rem] ml-2 rounded-tr-3xl rounded-br-3xl">
          <div className="shadow-[0px_3px_0px_0px_#1a202c] flex items-center h-28 justify-end pr-4 rounded-tl-3xl rounded-tr-3xl bg-white">
            <Image
              src="/chat-logo.png"
              alt="sonup-logo"
              width={70}
          ...
          <div className="h-[33rem] rounded-br-3xl rounded-bl-3xl bg-white">
            test
          </div>
        </div>
      </div>
